...
Strips HTML tags and dangerous characters to prevent XSS attacks.
Uses Python's built-in html.parser — zero extra dependencies.
"""
...
def sanitize_text(value):
    ...
    # Normalize line endings but preserve intentional paragraph breaks
    cleaned = re.sub(r"\n{3,}", "\n\n", cleaned)
