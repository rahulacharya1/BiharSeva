...
import { FiArrowLeft, FiLogOut, FiTrash2, FiMapPin, FiUser, FiActivity, FiSearch, FiFilter } from "react-icons/fi";
...
export function AdminReportsPage({ adminUser, onLogout }) {
    ...
    const updateStatus = async (id, status) => {
        await adminApi.patch(`/admin/reports/${id}/`, { status });
        setMessage({ type: "success", text: "Report status synchronized" });
        loadReports();
    };
