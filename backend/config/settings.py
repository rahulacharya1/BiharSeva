...
ALLOWED_HOSTS = env_list("ALLOWED_HOSTS", default="127.0.0.1,localhost,api.biharseva.acharyaworks.in,.onrender.com")
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'common.exception_handler.standardized_exception_handler',
...
LOGGING = {
    ...
    'filters': {
        'skip_4xx': {
            ...
            'callback': lambda record: getattr(record, 'status_code', 200) < 400
                                       or getattr(record, 'status_code', 200) >= 500,
        },
    },
    'formatters': {
        'verbose': {
